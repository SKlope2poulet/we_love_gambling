# ui_roulette_fr.py
# Interface Tkinter : table cliquable, mise par clic,suppression par clic sur jetons,
# historique en bas. Utilise le module modele_roulette_fr.py

import tkinter as tk
from tkinter import ttk, messagebox

from modele_roulette import Bet, Game  # logique importée
